    ...
    <Dashboard activeMenu="Thông báo">
      <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="bg-white dark:bg-[#0F172A] border border-slate-200/60 dark:border-white/10 rounded-3xl overflow-hidden shadow-sm flex flex-col min-h-[450px]">
          {loading ? (
            <div className="py-20 flex flex-col items-center justify-center my-auto">
              <div className="w-8 h-8 rounded-full border-2 border-slate-200 border-t-violet-600 animate-spin mb-4"></div>
              <p className="text-sm font-semibold text-slate-500 dark:text-slate-400">Đang tải thông báo...</p>
            </div>
