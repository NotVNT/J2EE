import {
  hasDisplayImage,
  hideBrokenImageWrapper,
} from "../util/imageDisplay.js";
...
const BudgetCard = ({ budget, onDelete }) => {
  ...
  return (
    <div
      className={`budget-card ${isExceeded ? "budget-card--danger" : isWarning ? "budget-card--warning" : ""}`}
    >
      <div className="budget-card__header">
        <div className="budget-card__category">
          ...
          <div>
            <p className="budget-card__name text-slate-900">{categoryName}</p>
      ...
      <div className="budget-card__stats">
        <div>
          ...
          <p className="budget-card__value  text-slate-900">
            {fmt(totalSpent)}
          </p>
        </div>
