...
const SavingGoalForm = ({ initialData, isEditing, onSave, onCancel }) => {
    ...
    const handleSubmit = () => {
        ...
        if (!form.targetDate) { alert("Vui lòng chọn hạn chót"); return; }
        if (isIsoDateAfter(form.startDate, form.targetDate)) { alert("Hạn chót phải sau hoặc bằng ngày bắt đầu"); return; }
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            {!isEditing && (
                <div>
                    <label className={labelClass}>Số tiền đã tích luỹ ban đầu (VND)</label>
                    <input
                        type="text"
