...
export default function ExpenseEmptyState() {
  ...
  return (
    <View style={styles.emptyState}>
      ...
      <Text style={[styles.emptyTitle, { color: colors.TEXT }]}>{t("expenseEmptyState.title")}</Text>
      <Text style={[styles.emptyText, { color: colors.TEXT_SECONDARY }]}>{t("expenseEmptyState.description")}</Text>
    </View>
  );
}
